<?php
/**
 * Title: Contained Imaged Callout
 * Slug: meetgoat/layout-callout-contained-image
			...
			<div class="wp-block-columns isp-cta__columns">
				...
				<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:48%">
					...
					<div class="wp-block-group isp-cta__content">
						<!-- wp:separator {"align":"full","className":"is-style-squiggle-brown"} -->
						...
						<h3
							class="wp-block-heading isp-cta__title has-isp-bistre-color has-text-color has-medium-font-size">
